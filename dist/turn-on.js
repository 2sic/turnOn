...
var ConfigHelper = /** @class */ (function () {
    ...
    ConfigHelper.stabilize = function (raw) {
        ...
        var logMode = ((_a = raw === null || raw === void 0 ? void 0 : raw.debug) !== null && _a !== void 0 ? _a : false) ? _turnOn_settings__WEBPACK_IMPORTED_MODULE_1__.LogDebug : _turnOn_settings__WEBPACK_IMPORTED_MODULE_1__.LogError;
        var stable = {
            await: awaits,
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "AttributeTurnOn": () => /* binding */ AttributeTurnOn,
/* harmony export */   "AttributeSkip": () => /* binding */ AttributeSkip,
/* harmony export */   "windowName": () => /* binding */ windowName,
/* harmony export */   "logPrefix": () => /* binding */ logPrefix
/* harmony export */ });
var AttributeTurnOn = 'turn-on';
var AttributeSkip = 'turn-on-skip';
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "AttributeSkip": () => /* reexport safe */ _constants__WEBPACK_IMPORTED_MODULE_0__.AttributeSkip,
/* harmony export */   "AttributeTurnOn": () => /* reexport safe */ _constants__WEBPACK_IMPORTED_MODULE_0__.AttributeTurnOn,
...
var ConfigTagManager = /** @class */ (function () {
    ...
    ConfigTagManager.prototype.tryToLoadTag = function (node) {
        ...
        var attr = (_a = node === null || node === void 0 ? void 0 : node.getAttribute) === null || _a === void 0 ? void 0 : _a.call(node, ___WEBPACK_IMPORTED_MODULE_0__.AttributeTurnOn);
        if (!attr)
            return;
        var skip = (_b = node === null || node === void 0 ? void 0 : node.getAttribute) === null || _b === void 0 ? void 0 : _b.call(node, ___WEBPACK_IMPORTED_MODULE_0__.AttributeSkip);
...
var ConfigTag = /** @class */ (function () {
    ...
    ConfigTag.prototype.syncDom = function () {
        ...
        if (!tag.getAttribute(___WEBPACK_IMPORTED_MODULE_0__.AttributeSkip))
            tag.setAttribute(___WEBPACK_IMPORTED_MODULE_0__.AttributeSkip, "skip");
        var currentSerialized = JSON.stringify(this.config);
        if (tag.getAttribute(___WEBPACK_IMPORTED_MODULE_0__.AttributeTurnOn) !== currentSerialized)
            tag.setAttribute(___WEBPACK_IMPORTED_MODULE_0__.AttributeTurnOn, currentSerialized);
    };
...
var queryForUnprocessedTags = "[" + ___WEBPACK_IMPORTED_MODULE_0__.AttributeTurnOn + "]:not([" + ___WEBPACK_IMPORTED_MODULE_0__.AttributeSkip + "])";
var ELEMENT_NODE = 1; // https://developer.mozilla.org/en-US/docs/Web/API/Node
/**
...
var TagLoader = /** @class */ (function () {
    ...
    TagLoader.prototype.scanExistingDom = function () {
        ...
        if (document.documentElement)
            ...
            (0,___WEBPACK_IMPORTED_MODULE_0__.log)('body not ready - changes will be detected by mutation observer');
    };
    TagLoader.prototype.checkAndLoadChildren = function (parent) {
        var _this = this;
        var _a;
        (0,___WEBPACK_IMPORTED_MODULE_0__.log)('checkAndLoadChildren', parent);
        if (!((_a = parent === null || parent === void 0 ? void 0 : parent.children) === null || _a === void 0 ? void 0 : _a.length))
            return;
        var tags = parent.querySelectorAll(queryForUnprocessedTags);
        tags.forEach(function (t) { return _this.tagManager.tryToLoadTag(t); });
    };
    TagLoader.prototype.activateObserver = function () {
        var _this = this;
        (0,___WEBPACK_IMPORTED_MODULE_0__.log)('activateObserver');
        this.observer = new MutationObserver(function (mutations) {
            (0,___WEBPACK_IMPORTED_MODULE_0__.log)('mutations detected', mutations);
            ...
            mutations.forEach(function (m) {
                ...
                if (m.type != 'childList')
                    return;
                (0,___WEBPACK_IMPORTED_MODULE_0__.log)('childList changes');
                var nodesAsArray = Array.from(m.addedNodes);
                nodesAsArray
                    .filter(function (n) { return n.nodeType === ELEMENT_NODE; })
                    .forEach(function (node) {
                    var _a;
                    if ((_a = node === null || node === void 0 ? void 0 : node.getAttribute) === null || _a === void 0 ? void 0 : _a.call(node, ___WEBPACK_IMPORTED_MODULE_0__.AttributeTurnOn))
                        _this.tagManager.tryToLoadTag(node);
                    else
                        _this.checkAndLoadChildren(node);
                });
            });
        });

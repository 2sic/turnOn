...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"booleanToStatusPromise\": () => /* binding */ booleanToStatusPromise\n/* harmony export */ });\n/* harmony import */ var ___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! . */ \"./src/turnOn/index.ts\");\n\r\nfunction booleanToStatusPromise(boolPromise) {\r\n    return new Promise(function (resolve, reject) {\r\n        boolPromise\r\n            .then(function (r) {\r\n            var result = r !== false;\r\n            resolve(new ___WEBPACK_IMPORTED_MODULE_0__.Status(result, 'from promise'));\r\n        })\r\n            .catch(function (reason) { return reject(reason); });\r\n    });\r\n}\r\n\n\n//# sourceURL=webpack://experimental-js-dynamic-loader/./src/turnOn/promise-boolean-to-status.ts?");
